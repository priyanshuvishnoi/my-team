...
const AddPlayer = ({ addPlayer }) => {
    ...
    const handleSubmit = (e) => {
        ...
        const newPlayer = { name: name, country: country, batstyle: batstyle, bowlstyle: bowlstyle }
        addPlayer(newPlayer);
        setName('')
        setCountry('')
        setBat('')
    ...
    return (
        ...
        <div >
            ...
            <br />
            <div className="col-2">
                <Form.Control type='text' placeholder='Batting Style' value={batstyle} onChange={(e) => setBat(e.target.value)} />
            </div>
            <br />

            <div className="col-2">
                <Form.Control type='text' placeholder='Bowling Style' value={bowlstyle} onChange={(e) => setBowl(e.target.value)} />
            </div>
            <br />

            <Button variant="primary" type="submit" className="col-2">Add Player</Button>
        </Form>
        </div>
